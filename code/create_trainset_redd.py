...
SAVE_PATH = 'created_data/REDD/microwave/'
...
def main():
    ...
    for h in params_appliance[appliance_name]['houses']:
        ...
        if h == params_appliance[appliance_name]['test_build']:
            ...
            print(args.save_path + appliance_name +
                  '_test_.pkl.zip')
            df_align.to_pickle(args.save_path + appliance_name +
    ...
    val.to_pickle(args.save_path + appliance_name + '_validation_' +
                  '.pkl.zip', compression='zip')

    # Training PKL
    train.to_pickle(args.save_path + appliance_name +
